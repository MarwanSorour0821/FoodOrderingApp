...
namespace Application
{
	public class ApplicationDbContext : DbContext
	{
		...
		protected override void OnModelCreating(ModelBuilder modelbuilder)
		{
			...
			//One-To-One Relationship with Role and User
			modelbuilder.Entity<User>().HasOne(u => u.role).WithOne(r => r.user).HasForeignKey<Role>().OnDelete(DeleteBehavior.Restrict);
